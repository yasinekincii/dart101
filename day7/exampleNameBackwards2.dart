...
print(metin[i]); //String değerinden[i] leri aldığımız için her bir harf 1 indekstir.
  ...
  //yasin ekinci length= 12. indeks 0 dan başladığı için -1 atıyoruz ki 12. değer yok
List<String> metin2 = ["yasin", " ", "ekinci"];
//metin2[0]="yasin"
//metin2[""]=" "
//bu listenin lengthi 3 virgüller ile indeksler ayrılır.
}
