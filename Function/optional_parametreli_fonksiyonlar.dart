...
//sayi1,sayi2,sayi3 ü mutlaka bu sayıda ve bu sırada atandığı bir parametre listesine ihtiyacı var.


//optional
/* int sayilariTopla(int sayi1, [int sayi2 = 0, int sayi3 = 0]) {  ---MAİNDE SAYI2,3'Ü KULLANICI İSTEMEZSE YAZMAZ. BURADA =0 YAZIYORUZ ÇÜNKÜ DARTTA DEĞİŞKENE NULL DEĞER ATAYAMAYIZ YASAKTIR.
  return sayi1 + sayi2 + sayi3;                                    ---SAYİ2,3 =0 Diyerek onlara default bir değer atadık.
} */
